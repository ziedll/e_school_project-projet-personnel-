    ...
    return MaterialApp(
      ...
      theme: ThemeData.dark().copyWith(
          ...
          inputDecorationTheme: InputDecorationTheme(
            ...
            labelStyle:
                TextStyle(fontSize: 18.0, color: kTextBlackColor, height: 1),
            //hint style
            hintStyle:
                TextStyle(fontSize: 18.0, color: kTextWhiteColor, height: 1),
            ...
            focusedErrorBorder: UnderlineInputBorder(
              borderSide: BorderSide(color: kErrorBorderColor, width: 1.20),
            ),
          )),
